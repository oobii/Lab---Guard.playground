...
*/
// function can return nil if input parameters are not both positive Ints
...
if let area = calculateArea(x: 10, y: 20) {
    print("Area is \(area)")
}

if let area = calculateArea(x: 10, y: -6) {
    print("Area is \(area)")
}
/*:
...
func add(first: Int?, second: Int?) -> Int? {
    ...
    guard let p1 = first else {
        return nil
    }
    guard let p2 = second else {
        return nil
    }
